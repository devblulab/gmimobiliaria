...
import { Navigation } from "../../components/contatos/nav";
import { Card } from "../../components/contatos/card";

const socials = [
  {
    icon: <Twitter size={20} />,
    href: "https://github.com/devblulab",
    label: "Twitter",
    handle: "@EnygmaEnterprise",
  },
  {
    icon: <Mail size={20} />,
    href: "enygmadevlab@gmail.com",
    label: "Email",
    handle: "enygmadevlab@gmail.com",
  },
  {
    icon: <Github size={20} />,
    href: "https://github.com/devblulab",
    label: "Github",
    handle: "Enygma-Dev-Lab",
  },
];
